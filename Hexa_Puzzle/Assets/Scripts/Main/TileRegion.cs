...
public class TileRegion : MonoBehaviour {
    ...
    public Vector3 GetBotPosition(Vector2 bottomPosition)
    {
        return MonoUtils.instance.piecesBottomTransform.TransformPoint(GetLocalPosition(bottomPosition) * Const.SCALED_TILE);
    }
    ...
    private bool ShowHint(Piece piece)
    {
        ...
        foreach(var samePiece in samePieces)
        {
            if (samePiece.isRedundant) continue;
