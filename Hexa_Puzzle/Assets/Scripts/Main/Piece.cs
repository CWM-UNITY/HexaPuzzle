...
public class Piece : MonoBehaviour {
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        else
        {
            ...
            iTween.MoveTo(gameObject, iTween.Hash("position", TileRegion.instance.GetBotPosition(bottomPosition), "speed", 15f, "oncomplete", "CompleteMoveToBottom_EndDrag"));
        }
    ...
    public void MoveToBottom()
    {
        if (status == Status.OnBoard)
        {
            ...
            TileRegion.instance.ClearCovers(this);
            iTween.ScaleTo(gameObject, iTween.Hash("scale", Vector3.one * Const.SCALED_TILE, "speed", 4f));
            iTween.MoveTo(gameObject, iTween.Hash("position", TileRegion.instance.GetBotPosition(bottomPosition), "speed", 20f, "oncomplete", "CompleteMoveToBottom"));
            status = Status.OnTween;
        }
    }
